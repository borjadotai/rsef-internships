...
const Post = () => {
  ...
  return (
    <Container>
      <Heading my={20}>Submit a new opportunity to our database</Heading>
      ...
      {(content.hasAllowance === 'One time allowance' ||
        ...
        <FormControl id="allowanceAmount" isRequired mb={marginBetweenElements}>
      ...
      <FormControl id="season" isRequired mb={marginBetweenElements}>
        ...
        <Select name="season" onChange={onChange} placeholder="Choose a season">
      ...
      <FormControl id="url" isRequired mb={marginBetweenElements}>
        <FormLabel>Link to more information and or application form</FormLabel>
        <Input
          type="url"
          name="url"
          value={content.url}
      ...
      <FormControl id="promotionalImages" isRequired mb={marginBetweenElements}>
        <FormLabel>URL of promotional image</FormLabel>
        <Input
          type="url"
          name="promotionalImages"
          value={content.promotionalImages}
          onChange={onChange}
